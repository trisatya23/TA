                ...
                <div class="col-md-12">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button class="btn" data-bs-toggle="modal" data-bs-target="#editreim"
                                                title="View Data"><i class="fa-solid fa-upload"></button></i>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="modal fade modal-lg" id="editreim" tabindex="-1" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Validasi Reimbursement</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form action="">
                                        <div class="row m-1">
                                            ...
                                            <div class="mb-3 col-md-12">
                                                <hr>
                                                <h6 class="fw bold">Bukti Pembayaran Reimbursement</h6>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label for="jumlah_uang" class="form-label">Total Reimbursement</label>
                                                <input type="text" class="form-control form-control-md"
                                                    id="jumlah_uang" name="jumlah_uang"
                                                    aria-describedby="emailHelp" value="Rp. 1.500.000" disabled >
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label for="bukti_reimbursement" class="form-label">File Reimbursement</label>
                                                        <input type="file" class="form-control form-control-md"
                                                                id="bukti_reimbursement" name="bukti_reimbursement"
