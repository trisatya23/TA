...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="fw-bold mb-3">Request Reimbursement</h3>
        </div>
        <div class="col-md-12">
            <div class="row my-4">
                <div class="col-md-12">
                    <button class="btn btn-dark mb-4" data-bs-toggle="modal" data-bs-target="#addreim"><i
                            class="fa-solid fa-plus"></i> Add Reimbursement</button>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button class="btn" data-bs-toggle="modal" data-bs-target="#viewreim"
                                                title="View Data"><i class="fa-solid fa-eye"></button></i>
                                            <button class="btn" data-bs-toggle="modal" data-bs-target="#editreim"
                                                title="View Data"><i class="fa-solid fa-pen"></button></i>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    {{-- add user modal --}}
                    <div class="modal fade modal-lg" id="addreim" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Add Reimbursement</h1>
                                        ...
                                        <div class="row m-1">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input type="date" class="form-control form-control-md" id="return_date"
                                                    name="return_date" aria-describedby="emailHelp">
                                            </div>
                                            <div class="mb-3 col-md-12">
                                                <label for="travel_desc" class="form-label">Keperluan Berangkat</label>
                                                <textarea class="form-control form-control-md" id="travel_desc" name="travel_desc" aria-describedby="emailHelp"></textarea>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input type="file" class="form-control form-control-md"
                                                    id="surat_perjalanan_dinas" name="surat_perjalanan_dinas"
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input type="file" class="form-control form-control-md"
                                                    id="file_transportasi" name="file_transportasi"
                                                    aria-describedby="emailHelp">
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label for="jumlah_transportasi	" class="form-label">Biaya Transportasi</label>
                                                <input type="text" class="form-control form-control-md"
                                                    id="jumlah_transportasi	" name="jumlah_transportasi	"
                                                    aria-describedby="emailHelp">
                                            </div>
                                            <div class="mb-3 col-md-12">
                                                <hr>
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input type="file" class="form-control form-control-md"
                                                    id="file_penginapan" name="file_penginapan"
                                                    aria-describedby="emailHelp">
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label for="jumlah_penginapan" class="form-label">Biaya Penginapan</label>
                                                <input type="text" class="form-control form-control-md"
                                                    id="jumlah_penginapan" name="jumlah_penginapan	"
                                                    aria-describedby="emailHelp">
                                            </div>
                                            <div class="mb-3 col-md-12">
                                                <hr>
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <textarea class="form-control form-control-md" id="uang" name="uang" aria-describedby="emailHelp"
                                                    placeholder="Contoh : Bank BNI : 1234563678897 / a.n Trisatya"></textarea>
                                            </div>
                                            <div class="mb-3 col-md-6">
                    ...
                    {{-- view user modal --}}
                    <div class="modal fade modal-lg" id="viewreim" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">View Reimbursement</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                        ...
                                        <div class="row m-1">
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input type="date" class="form-control form-control-md"
                                                    ...
                                                    aria-describedby="emailHelp" value="2024-08-01" disabled>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label for="return_date" class="form-label">Rencana Kembali</label>
                                                <input type="date" class="form-control form-control-md"
                                                    id="return_date" name="return_date" aria-describedby="emailHelp"
                                                    value="2024-08-04" disabled>
                                            </div>
                                            <div class="mb-3 col-md-12">
                                                <label for="travel_desc" class="form-label">Keperluan Berangkat</label>
                                            ...
                                            <div class="mb-3 col-md-6">
                                                <label for="destination" class="form-label">Tujuan</label>
                                                <input type="text" class="form-control form-control-md"
                                                    id="destination" name="destination" aria-describedby="emailHelp"
                                                    value="Air Bersih" disabled>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label for="surat_perjalanan_dinas" class="form-label">Surat Perjalanan
                                                    Dinas</label><br>
                                                <label for="destination" class="form-label"><i class="fa-solid fa-file"></i> <a
                                                        href="#">suratperjalanan.pdf</a></label>
                                            </div>
                                            <div class="mb-3 col-md-12">
                                                <hr>
                                                <h6 class="fw-bold">Benefits</h6>
                                            ...
                                            <div class="mb-3 col-md-6">
                                                <label for="file_transportasi" class="form-label">File Transportasi</label>
                                                <br>
                                                <label for="file_transportasi" class="form-label"><i class="fa-solid fa-file"></i> <a
                                                        href="#">file_transportasi.pdf</a></label>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label for="jumlah_transportasi	" class="form-label">Biaya Transportasi</label>
                                                <input type="text" class="form-control form-control-md"
                                                    id="jumlah_transportasi	" name="jumlah_transportasi	"
                                                    aria-describedby="emailHelp" value="Rp. 500.000" disabled>
                                            </div>
                                            <div class="mb-3 col-md-12">
                                                <hr>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label for="penginapan" class="form-label">Penginapan</label>
                                                <select class="form-control" id="penginapan" name="penginapan" disabled>
                                            ...
                                            <div class="mb-3 col-md-6">
                                                <label for="file_penginapan" class="form-label">File Penginapan</label>
                                                <br>
                                                <label for="file_penginapan" class="form-label"><i class="fa-solid fa-file"></i> <a
                                                        href="#">file_penginapan.pdf</a></label>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label for="jumlah_penginapan" class="form-label">Biaya penginapan</label>
                                                <input type="text" class="form-control form-control-md"
                                            ...
                                            <div class="mb-3 col-md-6">
                                                <label for="uang" class="form-label">Detail Pengiriman Uang
                                                    Saku</label>
                                                <textarea class="form-control form-control-md" id="uang" name="uang" aria-describedby="emailHelp"
                                                    placeholder="Contoh : Bank BNI : 1234563678897 / a.n Trisatya" disabled></textarea>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label for="file_uang" class="form-label">File Uang Saku</label>
                                                <br>
                                                <label for="file_uang" class="form-label"><i class="fa-solid fa-file"></i> <a
                                                        href="#">file_uang.pdf</a></label>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label for="jumlah_uang" class="form-label">Biaya Uang Saku</label>
                                                <input type="text" class="form-control form-control-md"
                    ...
                    <div class="modal fade modal-lg" id="editreim" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Reimbursement</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form action="">
                                        <div class="row m-1">
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input type="date" class="form-control form-control-md"
                                                    id="departure_date" name="departure_date"
                                                    aria-describedby="emailHelp" value="2024-08-01">
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label for="return_date" class="form-label">Rencana Kembali</label>
                                                <input type="date" class="form-control form-control-md"
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input type="text" class="form-control form-control-md"
                                                    id="jumlah_transportasi	" name="jumlah_transportasi	"
                                                    aria-describedby="emailHelp" value="Rp. 500.000">
                                            </div>
                                            <div class="mb-3 col-md-12">
                                                <hr>
                                            </div>
