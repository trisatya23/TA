...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="fw-bold mb-3">Request Perjalanan Dinas</h3>
        </div>
        <div class="col-md-12">
            <div class="row my-4">
                <div class="col-md-12">
                    <button class="btn btn-dark mb-4" data-bs-toggle="modal" data-bs-target="#addperdi"><i
                            class="fa-solid fa-plus"></i> Add Perjalanan Dinas</button>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button class="btn" data-bs-toggle="modal" data-bs-target="#editperdi"
                    ...
                    {{-- add user modal --}}
                    <div class="modal fade modal-lg" id="addperdi" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                    ...
                    <div class="modal fade modal-lg" id="editperdi" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                        ...
                                        <div class="row m-1">
                                            ...
                                            <div class="mb-3 col-md-12">
                                                <label for="uang" class="form-label">Detail Pengiriman Uang
                                                    Saku</label>
                                                <textarea class="form-control form-control-md" id="uang" name="uang" aria-describedby="emailHelp"
                                                    placeholder="Contoh : Bank BNI : 1234563678897 / a.n Trisatya">Bank BNI : 1234563678897 / a.n Trisatya</textarea>
                                            </div>
                                        </div>
                                    </form>
                                </div>
